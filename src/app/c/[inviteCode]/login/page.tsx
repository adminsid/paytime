...
export default function BrandedLoginPage({ params }: PageProps) {
  ...
  // Branded login screen for premium companies
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-blue-50/50 to-white px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1.5 text-sm text-gray-500">Sign in to your contractor tracking dashboard</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link
            href={`/c/${company.inviteCode}/register`}
            className="font-semibold text-blue-600 hover:underline"
          >
            Register to Join Portal
          </Link>
        </p>
      </div>
    </div>
